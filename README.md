...
The guinea pig exercise uses Javascript events to manipulate css classes and produce changes on the DOM.

## What to expect

User can interact with different sections and elements on the page with different results.

![DEMO](https://github.com/hagansmith/the-guinea-pig/blob/master/demo.gif)
